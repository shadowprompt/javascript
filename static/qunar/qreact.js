(function (global, factory) {
	...
	function getClosestInstanceFromNode(node) {
	  ...
	  // å®žé™…åªæœ‰ç»‘å®šäº†äº‹ä»¶çš„æ‰ä¼šæœ‰ internalInstanceKeyï¼Œæ‰€ä»¥åº”è¯¥ï¼š
	  // æ‰¾å‡ºèŠ‚ç‚¹æ‰€åœ¨åˆ†æ”¯ä¸Šæ‰€æœ‰ç»‘å®šäº†äº‹ä»¶çš„èŠ‚ç‚¹
	  // ç›´æŽ¥ä»Žçˆ¶èŠ‚ç‚¹å¼€å§‹
	...
	function processStyle(node, name, old, value) {
		...
		if (value && (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object') {
			...
			for (var _i in value) {
				...
				// mobileä¸ç”¨è€ƒè™‘IE8ï¼Œç›´æŽ¥è½¬æ¢ä¸ºcssFloatï¼Œä¹Ÿä¸ç”¨åšç»†æ‹†åˆ†
				if (_i === 'float') {
					_i = 'cssFloat';
				}
	...
	*	Benchmarks: https://esbench.com/bench/57ee8f8e330ab09900a1a1a0
	...
	function innerDiffNode(dom, vchildren, context, mountAll, absorb) {
		...
		// å¦‚æžœè¿˜æœ‰æ²¡æœ‰ç”¨å®Œçš„ child å›žæ”¶ä¹‹
		if (keyedLen) {
	...
	function setComponentProps(component, props, opts, context, mountAll) {
		...
		// å¦‚æžœæ²¡æœ‰å¯¹åº”çš„ DOM èŠ‚ç‚¹ï¼Œè¯´æ˜Žæ˜¯é¦–æ¬¡æŒ‚è½½
	...
	//ä¸ä½¿ç”¨å¤–é¢çš„cloneElement,ä½¿ç”¨è¿™é‡Œçš„
	...
	function createStringRefProxy(name, component) {
	    ...
	    return component._refProxies[name] || (component._refProxies[name] = function (resolved) {
	        if (component && component.refs) {
	            // while normalizeVNode ï¼Œå·²ç»ç¡®å®šäº†æ‰€æœ‰çš„ ref, åœ¨æ­¤ map å†… ä¸å¯ null
	...
	**/
	...
	// è¯·ä¸è¦ä¿®æ”¹ä¸‹æ–¹ä»£ç ï¼Œå¦åˆ™å°±ç‚’äº†ä½ 
