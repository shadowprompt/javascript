...
(function() {
    ...
    a.register("core.dom.insertBefore",
        function(b) {
            return function(d, e) {
                var c = e.parentNode;
                c.insertBefore(d, e)
    ...
    a.register("core.dom.hasClassName",
        function(b) {
            return function(d, c) {
    ...
    a.register("core.dom.addClassName",
        function(b) {
            return function(d, c) {
                if (d.nodeType === 1) {
    ...
    a.register("core.dom.removeClassName",
        function(b) {
            return function(d, c) {
                if (d.nodeType === 1) {
                    if (b.core.dom.hasClassName(d, c)) {
    ...
    a.register("core.evt.custEvent",
        function(d) {
            ...
            var f = {
                define: function(o, m) {
                    if (o && m) {
                        var l = (typeof o == "number") ? o: o[i] || (o[i] = c++),
                            n = h[l] || (h[l] = {});
                        m = [].concat(m);
                ...
                hook: function(t, v, n) {
                    ...
                    if (r) {
                        ...
                        var s = function(x) {
                            var w = true;
                            b(v, k[x.type].type, Array.prototype.slice.apply(arguments, [1, arguments.length]),
                                function() {
                                    w = false
                                });
                            w && x.preventDefault()
    ...
    a.register("core.dom.removeNode",
        function(b) {
            return function(c) {
                c = b.E(c) || c;
                try {
    ...
    a.register("core.io.scriptLoader",
        function(c) {
            var d = {};
            var b = {
                url: "",
    ...
    a.register("core.json.jsonToStr",
        function(e) {
            function g(f) {
                return f < 10 ? "0" + f: f
            }
    ...
    a.register("core.json.strToJson",
        function(h) {
            var e, c, b = {
                    '"': '"',
                    "\\": "\\",
    ...
    a.register("core.str.encodeHTML",
        function(b) {
            return function(c) {
                if (typeof c !== "string") {
    ...
    a.register("core.util.language",
        function(b) {
            return function(e, g) {
                var f = [];
                for (var d = 2,
                         c = arguments.length; d < c; d += 1) {
                    f.push(arguments[d])
                }
                return e.replace(/#L\{((.*?)(?:[^\\]))\}/ig,
                    function() {
                        var i = arguments[1];
                        var h;
                        if (g && g[i] !== undefined) {
    ...
    a.register("kit.dom.cssText",
        function(c) {
            var b = function(g, f) {
                var d = (g + ";" + f).replace(/(\s*(;)\s*)|(\s*(:)\s*)/g, "$2$4"),
                    e;
    ...
    a.register("kit.dom.fix",
        function(e) {
            var b = !(e.core.util.browser.IE6 || (document.compatMode !== "CSS1Compat" && a.IE)),
                c = /^(c)|(lt)|(lb)|(rt)|(rb)$/;
            function d(h) {
            ...
            function g(k, s, n) {
                ...
                var r = "fixed",
                    u, v, h, q, l = k.offsetWidth,
                    m = k.offsetHeight,
                    o = e.core.util.winSize(),
                    p = 0,
                    t = 0,
                    i = e.kit.dom.cssText(k.style.cssText);
                if (!b) {
                    r = "absolute";
            ...
            return function(i, o, j) {
                ...
                if (e.core.dom.isNode(i) && c.test(o)) {
                    var m = {
                        ...
                        setFixed: function(q) { (l = !!q) && g(i, k, p);
                            return this
                        },
    ...
    a.register("kit.dom.appendStyle",
        function(b) {
            return function(f, c) {
                var d = b.parseParam({
                        autoAppend: true,
    ...
    a.register("kit.num.limit",
        function(b) {
            return function(d, e, c) {
                return Math.min(c, Math.max(d, e))
            }
        });
    a.register("kit.dom.getCoordinates",
        function(b) {
            return function(c) {
                var d = b.position(c);
                return {
    ...
    a.register("kit.dom.offsetParent",
        function(c) {
            var b = /^(?:body|html)$/i;
            return function(e) {
                var d;
    ...
    a.register("module.draggable",
        function(g) {
            var c = g.core.util.browser,
                h = g.kit.num.limit,
                f = g.kit.dom.offsetParent,
                e = g.kit.dom.getCoordinates;
            var d = function(j) {
                var i = f(j);
            ...
            var b = {
                ...
                setCustEvents: function(k) {
                    var l = this,
                        i = this.conf,
                        m = k === "add" ? "add": "remove",
                        j = this.drag.getActObj();
                    g.foreach(["dragStart", "dragMove", "dragEnd"],
                        function(n) {
                            g.custEvent[m](j, (n === "dragMove" ? "draging": n),
                                function(p, o) {
                                    l.data = o;
                                    if (i.enable) {
                                        l[n](l.formatData(o))
            ...
            return function(f) {
                ...
                h.requestLogin = function() {
                    ...
                    h.loginTimer = setTimeout(function() {
                        ...
                        g.timeout);
                    e.login(h.para.userid, h.para.password, h.para.savestate, h.para.flag)
                };
    ...
    a.register("kit.evt.input_bindchange",
        function(c) {
    ...
    a.register("kit.util.buffer_pool",
        function(b) {
            return function(d) {
                var g = {};
                var f = b.parseParam({
    ...
    a.register("kit.dom.placeholder",
        function(d) {
            var c = d.core.json.merge;
            var b;
            return function(h, e) {
                ...
                g.compute_offset = function() {
                    var j = {};
                    d.foreach(["marginTop", "paddingTop", "borderTopWidth", "marginLeft", "paddingLeft", "borderLeftWidth"],
                        function(k) {
                            j[k] = d.getStyle(h, k);
                            if (j[k] == "auto") {
                                j[k] = "1px"
    ...
    a.register("common.util.door",
        function(e) {
            var d = e.core.json.merge,
                c = e.common.channel.sso;
            var b = function(k) {
                var g = {};
                var j = k.split("&");
                var f = [];
            ...
            return function(g) {
                ...
                i.argsCheck = function() {
                    h = e.parseParam({
                            ...
                            voice_service: "https://login.sina.com.cn/cgi/voicepin.php",
                            voice_para: {
                                p: "",
                                r: ""
                            },
    ...
    a.register("comp.login.outlogin",
        function(e) {
            var i = e.core.json.merge,
                f = e.kit.extra.template,
                k = e.kit.dom.builder,
                j = e.kit.dom.parseDOM,
                b = e.kit.evt.input_bindchange,
                c = e.kit.util.buffer_pool,
                h = e.kit.dom.placeholder,
                d = e.common.util.door,
                g = e.common.channel.sso;
            return function(n, q) {
                var p = {},
                    m = {},
                    l = false,
                    o = {
                        ...
                        entry: "",
                        door_address: "https://login.sina.com.cn/cgi/pin.php",
                        voiceEnable: true,
                        voice_swf: "https://i.sso.sina.com.cn/images/code_play.swf",
                        voice_service: "https://login.sina.com.cn/cgi/voicepin.php",
                        savestate: 30,
                        relative_node: null,
                        tip_capslockon: "",
                ...
                p.setTip = function(t, s) {
                    ...
                    if (m.tip && t !== "") {
                        if (t == "您已开启登录保护，请扫码登录") {
                            m.password.disabled = "disabled";
                            m.checkWrapper.style.display = "block";
                            m.submitWrapper.style.display = "block"
                        } else {
                            m.password.disabled = false;
                            m.checkWrapper.style.display = "none";
                            m.submitWrapper.style.display = "none"
                        }
                        m.tip.innerHTML = t;
                ...
                p.lockForm = function(s) {
                    s = !!s;
                    p.disabled = s;
                    e.foreach(["loginname", "password", "door", "vsn"],
                        function(u) {
                            var t = m[u];
                            t.readOnly = s
                        })
                ...
                p.getData = function() {
                    var s = {};
                    e.foreach(["loginname", "door", "vsn", "password"],
                        function(v) {
                            var u = m[v];
                ...
                p.submit = function() {
                    ...
                    if (p.validate(w, v)) {
                        ...
                        if (m.remember && m.remember.checked) {
                            u.savestate = o.savestate
                        }
                        var s = e.jsonClone(o.extra) || {};
                        var t = m.qrcode_img ? true: false;
                        if (v === "door") {
                            s.door = w.door
                        } else {
                            if (v === "vsn") {
                        ...
                        g.fire("login", [w.loginname, w.password, u, s, t])
                    }
                };
                ...
                p.checkFace = function() {
                    var u = window[o.ssoName];
                    var t = e.trim(m.loginname.value);
                    var s = m.qrcode_img ? true: false;
                    if (!t) {
                        return
                    }
                    if (e.getType(r[t]) !== "undefined") {
                        p.checkPin(r[t])
                    } else {
                        if (!u) {
                            return
                        ...
                        u.prelogin({
                            ...
                            function(v) {
                                if (v) {
                                    if (v.showpin) {
                                        p.checkPin(v.showpin)
                                    }
                                    r[t] = v.showpin;
                                    if (v.is_openlock == 1 && s == true) {
                                        m.tip.innerHTML = "您已开启登录保护,请扫码登录";
                                        m.tip.style.visibility = "visible";
                                        m.password.disabled = "disabled";
                                        m.submitWrapper.style.display = "block";
                                        return
                ...
                p.parseDom = function() {
                    ...
                    if (s) {
                        m = j(k(s).list);
                        p.nodes = m;
                        e.foreach(["root", "tip", "loginname", "password_box", "password", "door_box", "door", "door_img", "vsn_box", "vsn"],
                            function(t) {
                                if (!m[t]) {
                                    throw ("Can't find necessary node : " + t + " !")
                                }
                            });
                        e.foreach(["submit", "clear", "door_voice", "door_change", "forgot_password", "forgot_vsn", "register_button", "remember", "remember_label"],
                            function(t) {
                                if (!m[t]) {
    ...
    a.register("comp.layer.bubble.relate_tip",
        function(d) {
            var c = d.core.dom.getSize,
                e = d.kit.dom.builder,
                b = d.kit.dom.parseDOM;
            return function(g) {
                var k = {};
    ...
    a.register("comp.layer.suggestor.custom_loginname",
        function(h) {
            var i = h.core.arr.indexOf,
                k = h.core.dom.getSize,
                j = h.kit.arr.filter,
                c = h.kit.extra.language,
                f = h.kit.evt.input_bindchange,
                g = h.kit.util.buffer_pool,
                e = h.comp.layer.bubble.relate_tip;
            ...
            return function(q, n) {
                ...
                p.move_focus = function(u) {
                    ...
                    var r = j(["empty"].concat(o.email_list),
                        function(z) {
                            var y = p.items[z];
    ...
    a.register("comp.layer.outlogin",
        function(j) {
            var y = j.core.json.merge,
                h = j.core.util.language,
                s = j.core.io.jsonp,
                c = j.core.dom.getSize,
                B = j.kit.obj.append,
                C = j.kit.dom.fix,
                e = j.kit.dom.builder,
                k = j.kit.dom.parseDOM,
                r = j.kit.dom.loadStyle,
                x = j.kit.util.makeReady,
                b = j.kit.dom.appendStyle,
                A = j.module.mask,
                m = j.module.draggable,
                w = j.common.util.sso,
                f = j.common.channel.sso,
                u = j.comp.defaultStyle,
                p = j.comp.login.outlogin,
                z = j.comp.layer.suggestor.custom_loginname;
            var t = {};
            var d = {
            ...
            var g = {
                html: {
                    ...
                    layer: d.layer,
                    pre_login_img: "https://i.sso.sina.com.cn/images/login/pre_loading.gif"
                },
                extra: {
                    css: "",
                    ssologin: "https://i.sso.sina.com.cn/js/ssologin.js",
                    qrcodelogin: "https://i.sso.sina.com.cn/js/qrcode_login.js"
                },
                sso: {
                    entry: "sso",
                    setDomain: true,
                ...
                suggestor: {
                    ...
                    format_set: function(D) {
                        return '<a href="javascript:;" onclick="return false">' + j.encodeHTML(D) + "</a>"
                    },
                    format_get: function(E, D) {
                        if (E && D === "非新浪邮箱") {
                            E = E.split(/@/)[0]
                        }
                        return E
            ...
            v.fixDragOps = function() {
                var D = y({},
                    g.drag);
                if (!j.isNode(D.handle)) {
                    D.handle = t[D.handle]
                }
                D.exclude = [t.close];
                return D
            };
            v.prepareSSO = function(D) {
                if (!v.ssoReady) {
                    v.ssoReady = x({
                        condition: function() {
            ...
            v.prepareQRcode = function(D) {
                ...
                v.qrcodeReady.exec(D)
            };
            v.cssloaded = false;
            v.prepareCss = function(D) {
                if (!v.cssReady) {
                    v.cssReady = x({
                        condition: function() {
                            return v.cssloaded
                                ...
                                r(g.extra.css, {
                                    ...
                                    styleCheck: function() {
                                        if (j.isNode(t.css_check)) {
                                            var F = j.getStyle(t.css_check, "width");
                                            if (F === "123px") {
                                                return true
                                            }
                                        }
            ...
            v.prepare = function(D) {
                if (v.prepared) {
                    if (j.getType(D) === "function") {
                        D()
                    }
                    return
                }
            ...
            v.getQRcode = function() {
                if (window.SINA_QRCODE_LOGIN && !i) {
                    ...
                    i = true;
                    n = true;
                    D.getQRcode(function(E) {
                        if (E.retcode == 20000000) {
                            t.qrcode_img.src = E.data.image;
                            if (n) {
                                D.start()
                            }
                        }
            ...
            v.setQRcode = function() {
                if (window.SINA_QRCODE_LOGIN) {
                    ...
                    D.set({
                        ...
                        domain: g.sso.domain,
                        qrcode_size: 128
                    }).register("qrcode_timeout",
                        function(E) {
                            i = false;
                            v.getQRcode()
                        }).register("qrcode_exception",
                        function(E) {
                            i = false;
                            v.getQRcode()
                        ...
                        function(E) {
                            ...
                            f.fire("login_success")
                        }).register("login_failure",
                        function(E) {
                            f.fire("login_failure")
                        }).register("qrcode_scanned",
                        function(E) {
            ...
            v.build = function() {
                ...
                if (g.mask.enable) {
                    v.mask = A.showUnderNode(t.box, g.mask);
                ...
                if (t.loginname) {
                    ...
                    v.suggestor = z(t.loginname, g.suggestor)
                }
            ...
            v.insert = function() {
                ...
                var D = g.plugin.parentNode;
                if (!j.isNode(D)) {
                    D = document.body
                }
                if (!j.isNode(t.box.parentNode) || D !== v._currentParentNode) {
                    D.appendChild(t.box)
                }
                v._currentParentNode = D
            };
            v.parseDom = function() {
                if (!j.isNode(t.box)) {
                    ...
                    var D = h(g.html.layer, g.language);
                    var E = e(D);
                    l.nodes = t = k(E.list);
                    t.box = E.box;
                    v.insert()
            ...
            v.updateLayer = function() {
                ...
                if (j.isNode(E)) {
                    if (D.enable) {
                        j.setStyle(E, "cursor", "move");
                        v.drag.enable()
                    } else {
                        j.setStyle(E, "cursor", "auto");
                        v.drag.disable()
                    }
                }
            };
            v.setPosition = function() {
                var E = g.plugin.position,
                    J = c(t.box),
                    I,
                    D,
                    H,
                        ...
                        j.foreach(D,
                            function(K) {
                                if (H && G) {
                                    switch (K) {
                                        case "top":
                                            j.setStyle(t.box, "top", H.t + "px");
                                            break;
                                        case "bottom":
                                            j.setStyle(t.box, "top", H.t + G.height - J.height + "px");
                                            break;
                                        case "left":
                                            j.setStyle(t.box, "left", H.l + "px");
                                            break;
                                        case "right":
                                            j.setStyle(t.box, "left", H.l + G.width - J.width + "px");
                                            break;
                                        default:
                                            break
                                    }
                                } else {
                                    j.setStyle(t.box, K, "0px")
                                }
                            })
                    }
                }
                if (t.iframemask) {
                    var F = j.getStyle(t.box, "borderWidth");
                    F = parseInt(F, 10);
                    j.setStyle(t.iframemask, "width", J.width + "px");
                    j.setStyle(t.iframemask, "height", J.height + "px");
                    j.setStyle(t.iframemask, "marginLeft", 0 - F + "px");
                    j.setStyle(t.iframemask, "marginTop", 0 - F + "px")
                }
            };
            l.reset = function() {
                if (v.plugin) {
            ...
            l.getPreLoginWeiboData = function(D) {
                var F = y({
                        url: "https://api.weibo.com/2/users/show_brief.json",
                        args: {
                            source: "2835469272"
                        },
                        onTimeout: null,
                    ...
                    D);
                var G = j.getType(F.onSuccess) === "function" ? F.onSuccess: j.funcEmpty,
                    E = j.getType(F.onFailure) === "function" ? F.onFailure: j.funcEmpty;
                if (j.getType(F.onComplete) !== "function") {
                    F.onComplete = function(H) {
                        if (H && H.code && H.code != 1) {
                            v.displayLoginLayer();
                            E(H);
                            return
                        }
                        v.renderWeiboInfo(H.data.screen_name, H.data.profile_image_url);
                        G(H)
                    }
                }
                if (j.getType(F.onFail) !== "function") {
                    F.onFail = function(H) {
                        v.displayLoginLayer();
                        E({
                            code: -1,
            ...
            v.renderWeiboInfo = function(D, E) {
                if (!E || !D) {
                    return
                }
                E = E.replace(/\/5\d\//, "/180/");
                t.prelogin_name.innerHTML = D;
                t.prelogin_img.src = E
            };
            v.renderName = function(D) {
                if (j.bLength(D) > 10) {
                    D = j.leftB(D, 10)
                }
                return D
            ...
            v.getUserUid = function() {
                window.sinaSSOController.prelogin({},
                    function(D) {
                        t.loginname.prelogindata = D.uid
                    })
            };
            v.shake = (function() {
                var F = "ui-outlogin-shake";
                var G = "outlogin-layer-shake";
                var E = null;
                var D = function() {
                    if (E) {
                        return
                    ...
                    var I, L = [],
                        H = -16;
                    L.push("." + F + " {-webkit-animation:" + G + " 600ms;}\n");
                    L.push("@-webkit-keyframes " + G + " {\n");
                    for (I = 0; I < 11; I++) {
                        L.push([I * 10 + "% {", "-webkit-transform:translateX(", (I % 2 ? H: 0), "px);", "-webkit-animation-timing-function:", (I % 2 ? "ease-in": "ease-out"), ";}\n"].join(""));
                        if (I % 2) {
                            H = 0 - H / 2
                        }
                    }
                ...
                return function() {
                    if (g.plugin.shakeWhenError) {
                        ...
                        j.removeClassName(t.box, F);
                        setTimeout(function() {
                                j.addClassName(t.box, F)
                            },
                            100)
                    }
                }
            })();
            v.setEvents = function(D) {
                var E = D === "add" ? "addEvent": "removeEvent";
                j[E](t.close, "click", v.onClose);
                j[E](window, "unload", l.destroy);
                j[E](t.prelogin_changeAccount, "click", v.changeAccount)
            };
            v.setListener = function(D) {
                var E = D === "add" ? "register": "remove";
                f[E]("login_success", v.onLogin);
                f[E]("logout_success", v.onLogout);
                f[E]("login_failure", v.shake);
                f[E]("validate_failure", v.shake);
                f[E]("pre_login_state", v.preLogin)
            };
            l.setLoginButton = function(D) {
                j.Ready(function() {
                    if (j.getType(D) === "string") {
                        l.loginButton = j.E(D)
                    } else {
                        if (j.isNode(D)) {
                            l.loginButton = D
                    ...
                    if (l.loginButton) {
                        var F = h(g.html.button);
                        var E = e(F).box;
                        l.loginButton.appendChild(E);
                        j.addEvent(E, "click", l.show);
                        if (l.isLogin()) {
                            j.setStyle(E, "display", "none")
                        }
                        f.register("login_success",
                            function() {
                                j.setStyle(E, "display", "none")
                            });
                        f.register("logout_success",
                            function() {
                                j.setStyle(E, "display", "")
                            })
                    }
                });
                return l
            ...
            l.getSinaCookie = function() {
                var F = j.cookie.get("SUBP");
                if (!F) {
                    return null
                }
                var D = l.getSUBPCookie.decode(F);
                try {
                    D.uid = D.uid.replace(/(^\s*)|(\s*$)/g, "");
                    D.nick = decodeURIComponent(D.nick.replace(/(^\s*)|(\s*$)/g, ""))
                } catch(E) {
                    return null
                }
                return D
            ...
            l.getSUBPCookie = {
                ...
                decode: function(G) {
                    var F = [],
                        H,
                        E = G.substr(0, 3),
                        D = decodeURIComponent(G.substr(3));
                    switch (E) {
                        case "002":
                            F = l.base64.decode(D, "subp_v2", "array");
                            return l.getSUBPCookie.__parse(F);
                        case "003":
                            H = D.substr(0, 1);
                            D = D.substr(1);
                            F = l.base64.decode(D, "subp_v3_" + H, "array");
                            return l.getSUBPCookie.__parse(F);
                        default:
            ...
            l.base64 = {
                encode: function(F) {
                    ...
                    do {
                        ...
                        D = D + this._keys.charAt(L) + this._keys.charAt(J) + this._keys.charAt(H) + this._keys.charAt(G);
                        M = K = I = "";
                        L = J = H = G = ""
                    } while ( E < F . length );
                    return D
                },
                decode: function(L, I, E) {
                    var K = function(U, W) {
                    ...
                    if (L.length % 4 != 0) {}
                    var D = /[^A-Za-z0-9+\/=]/;
                    var P = this._keys.split("");
                    if (I == "urlsafe") {
                        D = /[^A-Za-z0-9-_=]/;
                        P = this._keys_urlsafe.split("")
                    }
                    if (I == "subp_v2") {
                        D = /[^A-Za-z0-9_=-]/;
                        P = this._subp_v2_keys.split("")
                    }
                    if (I == "subp_v3_3") {
                        D = /[^A-Za-z0-9-_.-]/;
                        P = this._subp_v3_keys_3.split("")
                    }
                    var H = 0;
                    if (I == "binnary") {
                        P = [];
            ...
            l.destroy = function() {
                ...
                j.foreach(["mask", "SSO", "plugin", "suggestor"],
                    function(D) {
                        var F = v[D];
            ...
            l.getWeiboInfo = function(D) {
                var F = y({
                        url: "https://api.sina.com.cn/weibo/wb/users_show.json",
                        uid: "",
                        args: {
                            uid: "",
                            source: "2835469272"
                ...
                if (j.getType(F.onComplete) !== "function") {
                    F.onComplete = function(H) {
                        ...
                        try {
                            ...
                            I.data = {
                                name: J.name,
                                avatar_large: J.avatar_large,
                                profile_url: J.profile_url,
                ...
                v.prepareSSO(function() {
                    var I = window.sinaSSOController;
                    var H;
                    if (j.getType(F.args) === "object") {
                        if (F.uid) {
                            F.args.uid = F.uid
                        } else {
                            if (I && j.getType(I.getLoginInfo) === "function") {
                                H = I.getSinaCookie();
                                F.args.uid = H.uid
                            }
                        }
            ...
            l.register = function(E, D) {
                f.register(E, D);
                return l
            };
            l.remove = function(E, D) {
                f.remove(E, D);
                return l
            };
            l.getNodes = function() {
